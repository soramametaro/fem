...
void multiMatandVec3(Matd* _A, Vec3d* _B, VecNd* _dst)
{
    ...
    if (_A->ncol == 3) {
        ...
        _dst->X[0] = _A->X[_A->ncol * 0 + 0] * _B->x + _A->X[_A->ncol * 0 + 1] * _B->y + _A->X[_A->ncol * 0 + 2] * _B->z;
        _dst->X[1] = _A->X[_A->ncol * 1 + 0] * _B->x + _A->X[_A->ncol * 1 + 1] * _B->y + _A->X[_A->ncol * 1 + 2] * _B->z;
        _dst->X[2] = _A->X[_A->ncol * 2 + 0] * _B->x + _A->X[_A->ncol * 2 + 1] * _B->y + _A->X[_A->ncol * 2 + 2] * _B->z;
        _dst->X[3] = _A->X[_A->ncol * 3 + 0] * _B->x + _A->X[_A->ncol * 3 + 1] * _B->y + _A->X[_A->ncol * 3 + 2] * _B->z;
    }
}
